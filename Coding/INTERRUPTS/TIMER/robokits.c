...
#define TIMER_1_CNT     0xfe5a		// 1 sec, use AVRcalc to calculate these values
									// ((TCNT1H=0xfc, TCNT1L=0x2e)
									// DECIMAL VALUE = 64558
									// MAX VALUE = 65535
									// TIMER OVERFLOW ON 65535-65114 = 421 COUNTS
#define CNT             0xfffc
#define TMC16_CK1024	(_BV(CS10))				// 16 BIT TIMER1 AT 1024 PRESCALAR
