This README file describes how metaboard (http://metalab.at/wiki/Metaboard)
can be used to implement a versatile In System Programmer (ISP) for AVR
microcontrollers.
...
* USBasp firmware ported to this hardware, AVR-Doper and AVRminiProg will
  follow.
...
directory "USBasp-firmware" contains a modified version of Thomas Fischl's
