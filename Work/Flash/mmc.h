...
#define	MMC_R1_READY				0x00	// Card is ready
...
// Macros
#define _mmc80SPIclocks		spiTransferByte(0xFF); \
...
#define _mmcCMD0			spiTransferByte(0x40); \
...
#define _mmcCMD1			spiTransferByte(0x41); \
							spiTransferByte(0x00); \
							spiTransferByte(0x00); \
							spiTransferByte(0x00); \
							spiTransferByte(0x00); \
...
#define _mmcBlockLen512 	spiTransferByte(0x50); \
							spiTransferByte(0x00); \
							spiTransferByte(0x00); \
